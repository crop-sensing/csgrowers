...
## Creates small map and marker of current site (WIN_001 in this case)
with col1.container(border = True, height = 290):
  ...
  fl.Marker(location = [float(st.secrets[site]["true_lat"]), float(st.secrets[site]["true_long"])], popup = "WIN_001").add_to(m)
